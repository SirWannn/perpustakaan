...
export default function Header({ searchValue, onSearchChange, placeholder = "Cari data...", hideSearch = false }) {
  return (
    <header className="flex items-center justify-between mb-8">
      <h1 className="text-xl font-bold text-gray-800">SDN Cijambe 1</h1>
      
      <div className="flex items-center gap-4">
        {/* Kolom Pencarian (Hanya Muncul Jika hideSearch bernilai false) */}
        {!hideSearch && (
