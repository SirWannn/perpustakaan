// Simple, dependency-free SVG icon set used across the app.
// Every icon accepts a `className` prop so it can be sized/colored with Tailwind.
...
export function LoanIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function EyeOffIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9.9 4.24A9.1 9.1 0 0 1 12 4c7 0 10.5 7 10.5 7a13.2 13.2 0 0 1-2.1 3.02M6.6 6.6C3.4 8.4 1.5 12 1.5 12s3.5 7 10.5 7a9.6 9.6 0 0 0 4.6-1.15" />
      <path d="M14.1 14.1a3 3 0 1 1-4.24-4.24" />
      <path d="m2 2 20 20" />
    </svg>
  );
}
...
export function FilterIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 4h16l-6.5 8.5v5.5l-3 2v-7.5Z" />
    </svg>
  );
}
